...
#define LEVEL_P_GAIN 2.2
#define LEVEL_I_GAIN 0.5
#define LEVEL_D_GAIN 0.8
#define LEVEL_I_MAX 5
...
#define LEVEL_AILERON_GAIN 0.04
#define LEVEL_ELEVATOR_GAIN 0.04
